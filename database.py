...
conn.execute('CREATE TABLE if not exists article (article_id INTEGER PRIMARY KEY NOT NULL, title TEXT, author INTEGER NOT NULL, content TEXT NOT NULL, is_active_article TEXT, date_created INTEGER, date_modified INTEGER, url TEXT, FOREIGN KEY (author) REFERENCES users(user_name))')
